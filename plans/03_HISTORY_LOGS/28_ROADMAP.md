...
### 28.3.1 AI Weaver Integration (Beta Readiness)
**Objective**: Test live AI service reliability and narrative quality at scale.
- [ ] Implement `aiService.ts` with Multi-provider support (Gemini/OpenAI).
- [ ] Test "Backstory Awakening" with high-concurrency LLM requests.
- [ ] Zero-failure fallback to local stubs on API timeout.
- [ ] Secure BYOK (Bring Your Own Key) flow for public beta testing.
