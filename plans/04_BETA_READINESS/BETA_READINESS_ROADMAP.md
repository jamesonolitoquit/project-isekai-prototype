...
### 2.3 AI Weaver Integration (Narrative Testing)
Ensure the AI-driven narrative is viable and stable for live deployment.
- Implement `AIService.ts` for multi-provider routing (Gemini/Mock).
- Test "Awakening" backstory interpretation.
- Validate live "Prologue Quest" synthesis.
...
- [ ] **Task 4: AI Weaver Connectivity Stress** (Deployment/AI)
  - Integrate live AI API for Character Awakening and Prologue Quest generation.
  - Objective: Test narrative quality and handle API latency/errors gracefully.
