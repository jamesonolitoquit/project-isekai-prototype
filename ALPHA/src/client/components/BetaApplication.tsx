...
// import TutorialOverlayComponent from './TutorialOverlay'; // [M48-A4: Temporarily disabled - missing component]
// import { AtmosphericFilterProvider } from '../hooks/useAtmosphericFilter'; // [M48-A4: Temporarily disabled - missing hook]
// import {
...
// import NarrativeInterventionOverlay, { useNarrativeWhispers, type DirectorWhisper } from './NarrativeInterventionOverlay'; // [M48-A4: Temporarily disabled - missing component]
    ...
    >
      ...
      <div style={{ flex: 1, display: 'flex', overflow: 'hidden' }}>
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
          ...
          {/* M44-E3: Tab Content [M48-A4: AtmosphericFilterProvider disabled] */}
          {/* <AtmosphericFilterProvider 
            state={state} 
            playerLocationId={state.player?.location}
          > */}
      ...
      >
        ...
        <div style={{ fontSize: '12px' }}>
          ...
          <div>Time: <span style={{ color: '#c084fc' }}>
            {state.hour.toString().padStart(2, '0')}:{ ( (state.time as any)?.minute ?? 0).toString().padStart(2, '0') }
          </span></div>
        </div>
      </div>
    </div>
