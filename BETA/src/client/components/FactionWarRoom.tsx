...
const FactionWarRoom: React.FC<FactionWarRoomProps> = ({
  ...
  // Filter locations based on contention level [M48-A4: Disabled - factionInfluenceMap not on LocationInfluence]
  const filteredStates = useMemo(() => {
    return influenceStates; // Return all states without filtering
  ...
  // Calculate contention level (gap between top factions) [M48-A4: Disabled - factionInfluenceMap not on LocationInfluence]
  ...
  const renderLocationCard = (state: LocationInfluence): JSX.Element => {
    ...
    const dominant = state.controllingFactionId || 'None'; // [M48-A4: Fixed property name]
    ...
    return (
      ...
      >
        ...
        >
          {/* [M48-A4: Disabled - factionInfluenceMap not on LocationInfluence] */}
